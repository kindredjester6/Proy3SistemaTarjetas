...
BEGIN
	...
	--Se agregan SaldoInteresesCorrientes, MontoDebitoInteresesCorrientes y TasaInteresesCorrientes, esta última se obtiene de una regla de negocio
	SET MontoDebitoInteresesCorrientes = SaldoActual / TasaInteresCorriente / 100 / 30, 
		...
		--El SaldoActual se modifica debido a lo que indica el documento: "El proceso de emisión de estados de cuenta se encarga de incorporar el 
